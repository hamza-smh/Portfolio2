                  ...
                  <div className="wpo-blog-content">
                    <div className="post format-standard-image">
                      ...
                      <div className="entry-meta">
                        <ul>
                          <li>
                            <i className="fi flaticon-user"></i> By <Link to="/">{author}</Link>
                          </li>
                          <li>
                            <i className="fi flaticon-comment-white-oval-bubble"></i> Comments {comment}
                          </li>
                          <li>
                      ...
                      <blockquote>
                        Combined with a handful of model sentence structures, generate Lorem Ipsum
