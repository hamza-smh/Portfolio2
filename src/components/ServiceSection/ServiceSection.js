                    ...
                    <Nav tabs>
                        ...
                        <NavItem>
                            <NavLink
                                ...
                                onClick={() => { toggle('3'); }}
                                style={{fontSize:"16px",textWrap:"nowrap",width:"fit-content",padding:"0px 15px"}}
                            >
                        ...
                        <TabPane tabId="1">
                            <div className="row align-items-center" style={{height:"66vh"}}>
                                {Services.slice(0, 3).map((service, srv) => (
                                    <div className="col-lg-4 col-md-6 col-12" key={srv} style={{height:"100%"}}>
                                        <div className="wpo-service-item" style={{height:"100%",backdropFilter:"blur(20px)"}}>
                                            {/* <div className="icon">
                                                <i className={`fi ${service.icon}`}></i>
                                            </div> */}
                                            <div  style={{padding:"30px",display:"flex",justifyContent:"center"}}>
                                                <img src={service.icon} alt="" className="fi" style={{width:"100px",height:"100px",
